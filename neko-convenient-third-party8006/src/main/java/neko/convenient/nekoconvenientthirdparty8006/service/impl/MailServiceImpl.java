...
import neko.convenient.nekoconvenientthirdparty8006.service.MailService;
...
public class MailServiceImpl implements MailService {
    ...
    public void sendRegisterMail(String emailAddress, String code) throws MessagingException {
        ...
        //标题
        mimeMessageHelper.setSubject("neko_market注册邮件");
        //正文
        mimeMessageHelper.setText("\n" +
                ...
                "      <br/>\n" +
                "      neko_convenient注册验证码为 <b>" + code + "</b>，有效时间5分钟，如果非本人操作，请不要处理此验证码" +
                "    </div>\n" +
                "  </body>\n" +
                "</html>\n", true);
