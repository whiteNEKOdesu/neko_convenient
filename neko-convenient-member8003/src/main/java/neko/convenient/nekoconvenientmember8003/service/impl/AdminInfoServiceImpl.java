...
public class AdminInfoServiceImpl extends ServiceImpl<AdminInfoMapper, AdminInfo> implements AdminInfoService {
    ...
    @Override
    public ResultObject<AdminInfoVo> logIn(String userName, String userPassword, HttpServletRequest request) {
        ResultObject<AdminInfoVo> resultObject = new ResultObject<>();
        AdminInfo adminInfo = this.baseMapper.getAdminInfoByUserName(userName);
